...
import com.teamtrack.auth.filter.JwtAuthenticationFilter;
 ...
 *
 * @Configuration          - Marks this as a Spring configuration class (bean source)
...
public class SecurityConfig {
    ...
    /**
     * @Bean - Registers SecurityFilterChain as a Spring-managed bean
     * Defines HTTP security: CSRF, CORS, session policy, URL authorization, filter chain
     */
    @Bean
